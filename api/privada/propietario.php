    ...
    switch ($_GET[ACTION]) {
        ...
        case CREATE:
            $_POST = $propietario->validateSpace($_POST);
                ...
                $result[EXCEPTION] = $propietario->setCorreo($_POST['correo_update']) ? null : 'Correo Electrónico incorrecto';
                ...
                $result[EXCEPTION] = $propietario->setDUI($_POST['FUI_update']) ? null : 'DUI incorrecto';
        ...
        case UPDATE:
            ...
            $result[EXCEPTION] = $propietario->setImagen($_POST['imagen_update']) ? null : 'Imagen incorrecto';
            $result[EXCEPTION] = $propietario->setIdTipoPropietario($_POST['id_tipo_propietario_update']) ? null : 'Tipo de propietario incorrecto';
            $result[EXCEPTION] = $propietario->setId($_POST['id_propietario']) ? null : 'Id incorrecto';
