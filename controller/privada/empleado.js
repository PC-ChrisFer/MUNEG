        ...
        content += ` 
            <tr>
                ...
                <td class="d-flex justify-content-center">
                    ...
                    <a onclick="guardarDatosinquilinoEliminar(${row.id_empleado})" class="btn" href="#" id="button_ver_mas" data-bs-toggle="modal"
...
window.guardarDatosEmpleadoUpdate = (id_empleado, 
    ...
    //@ts-ignore
    //@ts-ignore
    document.getElementById("estado_update").value = String(id_estado_empleado);
    //@ts-ignore
    document.getElementById("tipo_update").value = String(id_tipo_empleado);
}
