            ...
            <tr>  
                ...
                <td class="d-flex justify-content-center">
                    <div class="btn-group" role="group">
                            <a onclick="guardarDatosTipoInquilinoUpdate('${row.id_tipo_inquilino}', '${row.nombre_tipo}', '${row.visibilidad}')" class="btn btn-primary">
                                <img src="../../resources/img/iconos_formularios/edit_35px.png" data-bs-toggle="modal"
                                data-bs-target="#actualizar"></a>
                            <a  onclick="guardarDatosTipoInquilinoDelete('${row.id_tipo_inquilino}')"  class="btn btn-primary"  
                            name="search">
