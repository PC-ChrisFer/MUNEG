...
window.cambiarVisibilidadDeResgistro = () => {
    getElementById("verDatosliminados").checked === true ?  datos_tipo_propietario.visibilidad = true :  datos_tipo_propietario.visibilidad = false 
  ...
  window.leerDatosEliminados = async () => {
    getElementById("verDatosliminados").checked === true
      ? await readDeletedRowns(API_TIPO_PROPIETARIO, fillTableTipoPropietario)
      : await readRows(API_TIPO_PROPIETARIO, fillTableTipoPropietario);
  };
