...
export function fillTableTipoEmpleado(dataset) {
  ...
  dataset.map((row) => {
    ...
    <td class="d-flex justify-content-center">
      <a onclick="guardarDatosTipoEmpleadoUpdate(${row.id_tipo_empleado},${row.nombre_tipo})"  class="btn btn-primary class="btn" href="#" id="button_ver_mas" data-bs-toggle="modal"
        data-bs-target="#actualizar"><img
            src="../../resources/img/iconos_formularios/edit_35px.png"></a>
      <a onclick="guardarDatosTipoEmpleadoEliminar(${row.id_tipo_empleado})"  class="btn btn-primary class="btn" href="#" id="button_ver_mas" data-bs-toggle="modal"
...
// @ts-ignore
window.guardarDatosTipoEmpleadoEliminar = (id_tipo_empleado) => {
